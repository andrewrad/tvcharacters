...
class MainRecyclerViewAdapter(val clickListener: ItemClickListener) :  RecyclerView.Adapter<ViewHolder>() {  //ListAdapter<DbEntity, ViewHolder>(){//:
...
class ViewHolder private constructor(val binding: RecyclerviewListItemBinding): RecyclerView.ViewHolder(binding.root) {
